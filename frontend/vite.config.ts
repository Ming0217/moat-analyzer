...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'MoatAnalyzer',
        short_name: 'MoatAnalyzer',
        description: "Analyze company economic moats using Pat Dorsey's framework",
        theme_color: '#0f172a',
      ...
      workbox: {
        ...
        // so the app still opens offline but never shows stale financial data
        runtimeCaching: [
          {
